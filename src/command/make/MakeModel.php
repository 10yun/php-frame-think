...
class MakeModel extends Command
{
    ...
    protected function configure()
    {
        $this->setName('MakeModel')
            ...
            ->addOption('name', 'c', Option::VALUE_OPTIONAL, '模型')
    ...
    protected function execute(Input $input, Output $output)
    {
        ...
        // 命名空间
        $namespaceArr1 = $this->getNamespaceModel($dir, $nameInput);
        ...
        // 解析模版内容
        $putContent = str_replace(['{%namespaceClass%}', '{%className%}',], [
            $namespaceClass,
            $className,
        ], $stubContent);
        // 写入模版内容
        $filePath = "{$fileDir}/{$className}Models.php";
