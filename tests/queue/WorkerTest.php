...
class WorkerTest extends TestCase
{
    ...
    protected function setUp()
    {
        ...
        $this->handle = Mockery::spy(Handle::class);
        $this->event  = Mockery::spy(Event::class);
        $this->cache  = Mockery::spy(Cache::class);
    }
    ...
    public function testJobCanBeFired()
    {
        ...
        $this->event->shouldReceive('trigger')->with(Mockery::type(JobProcessing::class))->once();
        $this->event->shouldReceive('trigger')->with(Mockery::type(JobProcessed::class))->once();
    ...
    public function testWorkerCanWorkUntilQueueIsEmpty()
    {
        ...
        $this->event->shouldHaveReceived('trigger')->with(Mockery::type(JobProcessing::class))->twice();

        $this->event->shouldHaveReceived('trigger')->with(Mockery::type(JobProcessed::class))->twice();
    }
    ...
    public function testJobIsReleasedOnException()
    {
        ...
        $this->handle->shouldHaveReceived('report')->with($e);
        $this->event->shouldHaveReceived('trigger')->with(Mockery::type(JobExceptionOccurred::class))->once();
        $this->event->shouldNotHaveReceived('trigger', [Mockery::type(JobProcessed::class)]);
    }
    ...
    public function testJobIsNotReleasedIfItHasExceededMaxAttempts()
    {
        ...
        $this->handle->shouldHaveReceived('report')->with($e);
        $this->event->shouldHaveReceived('trigger')->with(Mockery::type(JobExceptionOccurred::class))->once();
        $this->event->shouldHaveReceived('trigger')->with(Mockery::type(JobFailed::class))->once();
        $this->event->shouldNotHaveReceived('trigger', [Mockery::type(JobProcessed::class)]);
    }
    ...
    public function testJobIsFailedIfItHasAlreadyExceededMaxAttempts()
    {
        ...
        $this->handle->shouldHaveReceived('report')->with(Mockery::type(MaxAttemptsExceededException::class));
        $this->event->shouldHaveReceived('trigger')->with(Mockery::type(JobExceptionOccurred::class))->once();
        $this->event->shouldHaveReceived('trigger')->with(Mockery::type(JobFailed::class))->once();
        $this->event->shouldNotHaveReceived('trigger', [Mockery::type(JobProcessed::class)]);
    }
